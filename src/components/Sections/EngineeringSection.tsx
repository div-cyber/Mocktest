    ...
    <div className="space-y-6">
      ...
      <div className="bg-black rounded-xl shadow-lg text-white p-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">Engineering Section</h1>
            <p className="text-gray-300">Master engineering concepts and excel in your exams</p>
          </div>
      ...
      <div className="min-h-96">
        {activeTab === 'notes' && <NotesTab section="engineering" />}
        {activeTab === 'tests' && <MockTestsTab section="engineering" />}
      </div>
    </div>
  );
};
